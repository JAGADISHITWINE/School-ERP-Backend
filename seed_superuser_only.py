...
MENU_DEFS = [
    ...
    ("Timetable", "/timetable", "CalendarClock", 4, "Teachers"),
    ("My Classes", "/classes", "School", 5, None),
    ("Attendance", "/attendance", "CalendarCheck", 6, None),
    ("Exams", "/exams", "ClipboardList", 7, None),
    ("Fees", None, "IndianRupee", 8, None),
    ("Fee Types", "/fees/types", "Tags", 1, "Fees"),
    ("Collect Fee", "/fees/collect", "CreditCard", 2, "Fees"),
    ("Reports", "/reports", "BarChart3", 9, None),
    ("Notifications", "/notifications", "Bell", 10, None),
    ("Library", "/library", "Library", 11, None),
    ("Settings", None, "Settings", 12, None),
